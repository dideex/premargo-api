...
class MarginStructure(BaseModel):
    """
    MarginStructure
    """ # noqa: E501
    before: Optional[List[MarginStructureComponent]] = None
    after: Optional[List[MarginStructureComponent]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "before": [MarginStructureComponent.from_dict(_item) for _item in obj["before"]] if obj.get("before") is not None else None,
            "after": [MarginStructureComponent.from_dict(_item) for _item in obj["after"]] if obj.get("after") is not None else None
        })
        return _obj
