...
class PreorderApi:
    ...
    def preorder_check_get(
        ...
        currency: Annotated[Optional[StrictStr], Field(description="Currency code")] = None,
        price: Optional[Union[StrictFloat, StrictInt]] = None,
        show_margin_structure: Optional[StrictBool] = None,
        ...
        :param price:
        :type price: float
        :param show_margin_structure:
        :type show_margin_structure: bool
        ...
        _param = self._preorder_check_get_serialize(
            ...
            currency=currency,
            price=price,
            show_margin_structure=show_margin_structure,
    ...
    def preorder_check_get_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PreorderCheckResponse]:
        """Estimate trade margin for one order
    ...
    def _preorder_check_get_serialize(
        ...
        if symbol_id is not None:
            ...
            _query_params.append(('symbolId', symbol_id))
        ...
        if show_margin_structure is not None:
            
            _query_params.append(('showMarginStructure', show_margin_structure))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1.0/preorder_margin/{account_id}',
